export const getPaidGroupSessionBookingMail = (c_fname, c_lname, dt_book, ssn_name) => {
    let html 
       =
       `<!DOCTYPE html>
       <html lang="en">
                                   ...
                                   <tr>
                                       ...
                                       <td style="padding: 1em 6%;">
                                           <p class="temp-content" style=" font-weight: 400; margin: 0;
                                               ...
                                               line-height: 1.5;">
                                               <br>
                                               <br>Your Group session “${ssn_name}” has been booked successfully at ${dt_book} . Please click the button below to check the details of the session. 
