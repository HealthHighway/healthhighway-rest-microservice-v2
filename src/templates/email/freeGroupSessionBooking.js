export const getFreeGroupSessionBookingMail = (c_fname, c_lname, dt_book, ssn_name) => {
    let html 
       = 
       `<!DOCTYPE html>
       <html lang="en">
                       ...
                       <tr>
                           <td>
                               <table width="100%" style="border-spacing: 0;">
                                   ...
                                   <tr>
                                       ...
                                       <td style="padding: 1em 6%;">
                                           <p class="temp-content" style=" font-weight: 400; margin: 0;
                                               ...
                                               line-height: 1.5;">
                                               <br>
                                               <br>Your Free group session “${ssn_name}” has been booked successfully at ${dt_book} . Please click the button below to check the details of the session. 
                                   ...
                                   <tr>
                                       <td style="vertical-align: middle;text-align: center;"> <a href="https://play.google.com/store/apps/details?id=com.healthhighwaylive" class="template-btn" style="margin: 1em 0;color:#ffffff">See Details</a></td>
                                   </tr>
                               </table>
                           </td>
                       </tr>
